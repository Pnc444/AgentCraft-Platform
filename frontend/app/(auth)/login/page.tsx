  ...
  return (
    <Reveal variant="scale" className="w-full max-w-md">
      <div className="card w-full p-8 shadow-elevated">
        <h1 className="text-2xl font-bold text-craft-ink">Welcome back</h1>
        <p className="mt-1 text-sm text-craft-muted">Log in to continue your learning path.</p>
