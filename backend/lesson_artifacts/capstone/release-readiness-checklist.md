...
- [ ] The permission table names each action, its door, and a one-line reason.
- [ ] The four evaluation cases ran: pass, revise, stop, and stay-fixed each behaved as expected.
