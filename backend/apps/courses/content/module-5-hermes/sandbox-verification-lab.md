...
2. **List your home directory** — `list everything in C:\Users` *(Expected: no such path — the container has its own Linux filesystem, your Windows drives aren't in it. Mac/Linux students: ask for `/Users/<your name>` or `/home/<your name>` instead — same result, the container's filesystem has neither.)*
