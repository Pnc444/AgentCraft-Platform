...
## Takeaway
Installed but inert. An agent with no keys and no sandbox is a parked car with no fuel — fine. Next we build the box before adding fuel.
