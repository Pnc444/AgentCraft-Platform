...
CURRICULUM = [
    ...
    },
    {
        ...
        "description": "Meet one small AI helper, learn the six questions that describe any agent, and design your own on paper. No installs, no jargon, one idea at a time.",
        "difficulty": 2,
        "lessons": [
            ("What an Agent Actually Is", "what-an-ai-agent-is", "theory", 10),
            ("Answerer, Checklist, or Agent?", "agents-vs-chatbots", "theory", 8),
            ("The Loop: Watch Juno Work", "basic-agent-workflow", "theory", 10),
            ("Checks and Stop Rules", "knowing-when-to-stop", "theory", 8),
            ("Notebook, Hands, Judgment", "memory-tools-reasoning", "theory", 9),
            ("Four Agents You Already Understand", "examples-of-real-ai-agents", "theory", 8),
            ("Design Your Own Juno (On Paper)", "design-your-first-agent", "interactive", 15),
        ],
    },
    {
        "order": 6,
    ...
    },
    {
        ...
        "description": "Give the agent you designed a real home: set up OpenClaw the official way, teach it three skills, open one front door, and run the built-in safety sweep.",
        "difficulty": 2,
        "lessons": [
            ("Set Up the Home Base", "configuration", "agent_lab", 15),
            ("Teach It Skills", "adding-skills", "agent_lab", 12),
            ("Open the Front Door (Just a Crack)", "channels", "interactive", 12),
            ("The Safety Sweep", "agent-safety", "theory", 12),
        ],
    },
    {
        "order": 9,
    ...
    },
    {
        ...
        "difficulty": 3,
        "lessons": [
            ("Work That Runs While You're Away", "automation-examples", "theory", 12),
            ("Guardrails: Values and Seatbelts", "guardrails", "theory", 10),
            ("Permissions: Three Kinds of Doors", "permissions", "theory", 10),
            ("The Release Decision", "testing", "interactive", 15),
        ],
    },
]
